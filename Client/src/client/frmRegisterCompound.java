...
public class frmRegisterCompound extends JFrame {
    ...
    private void jbInit() throws Exception {
        ...
        lstCompounds.setFont(new Font("Tahoma", 0, 12));
        lstCompounds.setBounds(new Rectangle(160, 30, 115, 130));
        btnClose.setText("Close");
        btnClose.setFont(new Font("Tahoma", 0, 12));
        ...
        jLabel2.setBounds(new Rectangle(160, 10, 100, 15));
